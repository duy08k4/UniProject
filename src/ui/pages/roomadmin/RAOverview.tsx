...
const RAOverview: React.FC = () => {
    return (
        <div className="w-full h-fit flex flex-col gap-10 pt-topPadding">
            <h1 className="text-largeSize font-bold dark:text-white">Tổng quan lớp học</h1>
            ...
            <div className="grid grid-cols-4 gap-5 max-sm:grid-cols-1">
                <div className="flex flex-col gap-2.5 px-7 py-5 shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-normal dark:bg-lightDark">
                    ...
                    <div className="flex items-center-safe gap-5">
                        <span className="flex items-center-safe gap-2">
                            ...
                            <p className="text-[32px] font-bold dark:text-white">30</p>
                        </span>
                        <span className="flex items-center-safe gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="size-6 dark:stroke-white">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.425 4.755 4.631 4.631 0 0 0 6.196 6.063m11.71-10.818a50.636 50.636 0 0 1 2.425 4.755 4.631 4.631 0 0 1-6.196 6.063m-11.71-10.818L12 3l9 4.773L12 12.544 4.26 10.147Z" />
                            </svg>
                            <p className="text-[32px] font-bold dark:text-white">03</p>
                        </span>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2.5 px-7 py-5 shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-normal dark:bg-lightDark">
                    ...
                    <div className="flex items-center-safe gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="size-8 dark:stroke-white">
