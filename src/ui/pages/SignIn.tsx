...
const SignIn: React.FC = () => {
    ...
    return (
        <div className="h-full w-full flex justify-center-safe items-center-safe">
            <div className="h-fit w-[450px] flex flex-col gap-5 px-10 py-15 rounded-normal shadow-[0_0_50px_20px_rgba(128,128,128,0.25)] max-sm:px-5 max-sm:py-10">
                ...
                <div className="flex justify-center-safe items-center-safe">
                    <p className="font-medium dark:text-white max-sm:text-smallSize max-sm:flex max-sm:flex-col max-sm:items-center-safe">
