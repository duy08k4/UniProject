...
const AuthLayout: React.FC = () => {
    return (
        <div className="h-full w-full bg-bgLight flex flex-col gap-15 px-twoSidePadding overflow-auto dark:bg-bgDark max-sm:px-mobile-twoSidePadding pt-10">
            <header>
                <NavLink to="/" className="w-fit flex items-center-safe gap-2.5 px-5 py-2.5 shadow-[0_0_12px_rgba(0,0,0,0.25)] rounded-normal hover:cursor-pointer dark:bg-white">
